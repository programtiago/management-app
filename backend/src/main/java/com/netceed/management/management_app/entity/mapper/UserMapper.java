...
public class UserMapper {
    ...
    public UserDto toDto(User user){
        ...
        return new UserDto(user.getId(), user.getFirstName(), user.getLastName(), user.getWorkNumber(), user.getBirthdayDate(), user.getDepartment(), user.getWorkStatus(), user.getShiftType(),
    ...
    public User toEntity(UserDto userDto){
        User user = new User(userDto.id(), userDto.firstName(), userDto.lastName(), userDto.workNumber(), userDto.birthdayDate(), userDto.department(), userDto.workStatus(), userDto.shiftType(),
